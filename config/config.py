...
class LipSickInferenceOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--source_video_path", type=str, required=False, help="Path to the source video")
        self.parser.add_argument("--source_openface_landmark_path", type=str, default=None, help="Path to the OpenFace landmarks file")
        self.parser.add_argument("--driving_audio_path", type=str, required=False, help="Path to the driving audio file")
